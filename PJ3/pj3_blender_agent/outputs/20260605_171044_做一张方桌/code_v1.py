...
# Create leg base at z=0
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, 0, 0))
leg_base = bpy.context.active_object
leg_base.name = "leg_base"
leg_base.scale = (0.9 / 2, 0.9 / 2, 0.02 / 2)
leg_base.data.materials.append(mat)

for i in range(4):
    bpy.ops.mesh.primitive_cylinder_add(radius=leg_radius, depth=leg_height, location=(0.45 * math.cos(math.radians(i * 90)), 0.45 * math.sin(math.radians(i * 90)), 0.78 - leg_height / 2))
