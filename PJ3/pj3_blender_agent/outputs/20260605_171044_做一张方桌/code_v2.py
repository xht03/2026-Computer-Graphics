...
for i in range(4):
    bpy.ops.mesh.primitive_cylinder_add(radius=leg_radius, depth=leg_height, location=(0.4 * math.cos(math.radians(i * 90)), 0.4 * math.sin(math.radians(i * 90)), 0.78 - leg_height / 2))
