...
total_height = 0.78
top_thickness = 0.02
leg_height_ratio = 0.6
leg_height = total_height * leg_height_ratio
leg_width = 0.08
leg_depth = 0.08

for i in range(4):
    bpy.ops.mesh.primitive_cylinder_add(radius=leg_width / 2, depth=leg_height, location=(0.45 * math.cos(i * math.pi / 2), 0.45 * math.sin(i * math.pi / 2), leg_height / 2))
