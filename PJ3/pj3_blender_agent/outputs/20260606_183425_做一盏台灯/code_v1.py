...
# COMPONENT: lamp_stem
bpy.ops.mesh.primitive_cylinder_add(radius=0.02, depth=0.2, location=(0, 0, 0.2))
stem = bpy.context.active_object
stem.name = "lamp_stem"
stem.data.materials.append(metal_mat)

# COMPONENT: bamboo_shade
# [sanitized] bpy.ops.mesh.primitive_cone_add(radius1=0.2, radius2=0.1, depth=0.15, location=(0, 0, 0.375))
shade = bpy.context.active_object
shade.name = "bamboo_shade"
shade.data.materials.append(bamboo_mat)

# COMPONENT: light_bulb_holder
bpy.ops.mesh.primitive_cylinder_add(radius=0.025, depth=0.1, location=(0, 0, 0.5))
holder = bpy.context.active_object
holder.name = "light_bulb_holder"
holder.data.materials.append(metal_mat)

CONNECTIONS = [
    ("wooden_base", "lamp_stem"),
    ("lamp_stem", "bamboo_shade"),
