...
# COMPONENT: shade
bpy.ops.mesh.primitive_cylinder_add(radius=0.09, depth=0.22, location=(0, 0, 0.55))
...
for i, z in enumerate(trim_heights):
    bpy.ops.mesh.primitive_torus_add(location=(0, 0, z), major_radius=0.09, minor_radius=0.005)
...
pattern_offsets = [(0.095, 0), (0, 0.095), (-0.095, 0), (0, -0.095)]
