...
# Profile in XY plane: X=thickness(0.02), Y=height(0.10)
apron_profile.from_pydata([(0,0,0), (0.02,0,0), (0.02,0.10,0), (0,0.10,0)], [(0,1),(1,2),(2,3),(3,0)], [(0,1,2,3)])
...
splat_profile.from_pydata([(0,0,0), (0.12,0,0), (0.12,0.015,0), (0,0.015,0)], [(0,1),(1,2),(2,3),(3,0)], [(0,1,2,3)])
...
# COMPONENT: back_splat (S-curved panel)
...
# COMPONENT: left_armrest (Goose neck curve with outward extension)
cu = bpy.data.curves.new("left_armrest_curve", type='CURVE')
cu.dimensions = '3D'
cu.bevel_depth = 0.012
sp = cu.splines.new('BEZIER')
sp.bezier_points.add(2)
# Extends outward in X at front, graceful curve
pts = [(x_left-0.05, y_front-0.03, 0.62), (x_left-0.03, y_front+0.08, 0.70), (x_left-0.01, (y_front+y_back)/2, 0.74), (x_left, y_back, 0.76)]
for bp, co in zip(sp.bezier_points, pts):
    bp.co = co
    bp.handle_left_type = bp.handle_right_type = 'AUTO'
...
sp = cu.splines.new('BEZIER')
sp.bezier_points.add(2)
pts = [(x_right+0.05, y_front-0.03, 0.62), (x_right+0.03, y_front+0.08, 0.70), (x_right+0.01, (y_front+y_back)/2, 0.74), (x_right, y_back, 0.76)]
for bp, co in zip(sp.bezier_points, pts):
    bp.co = co
    bp.handle_left_type = bp.handle_right_type = 'AUTO'
