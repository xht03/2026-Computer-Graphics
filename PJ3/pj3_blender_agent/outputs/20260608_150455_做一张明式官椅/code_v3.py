...
cu_lgn = bpy.data.curves.new("left_gooseneck_curve", type='CURVE')
cu_lgn.dimensions = '3D'
cu_lgn.bevel_depth = 0.02
sp_lgn = cu_lgn.splines.new('BEZIER')
sp_lgn.bezier_points.add(1)
pts_lgn = [(-0.255, 0.20, 0.52), (-0.275, 0.35, 0.72)]
for bp, co in zip(sp_lgn.bezier_points, pts_lgn):
    bp.co = co
    bp.handle_left_type = 'AUTO'
    bp.handle_right_type = 'AUTO'
left_gooseneck = bpy.data.objects.new("left_gooseneck", cu_lgn)
bpy.context.collection.objects.link(left_gooseneck)
left_gooseneck.data.materials.append(wood)

# COMPONENT: right_gooseneck
cu_rgn = bpy.data.curves.new("right_gooseneck_curve", type='CURVE')
cu_rgn.dimensions = '3D'
cu_rgn.bevel_depth = 0.02
sp_rgn = cu_rgn.splines.new('BEZIER')
sp_rgn.bezier_points.add(1)
pts_rgn = [(0.255, 0.20, 0.52), (0.275, 0.35, 0.72)]
for bp, co in zip(sp_rgn.bezier_points, pts_rgn):
    bp.co = co
    bp.handle_left_type = 'AUTO'
    bp.handle_right_type = 'AUTO'
right_gooseneck = bpy.data.objects.new("right_gooseneck", cu_rgn)
bpy.context.collection.objects.link(right_gooseneck)
