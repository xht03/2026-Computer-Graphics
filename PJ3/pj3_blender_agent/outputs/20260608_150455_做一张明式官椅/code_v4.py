...
bpy.ops.mesh.primitive_cube_add(size=1, location=(0, -0.20, 0.835))
back_splat = bpy.context.active_object
back_splat.name = "back_splat"
back_splat.scale = (0.12, 0.04, 0.63)
add_bevel(back_splat)
